...
class HuobiAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    def __init__(self,
        ...
        self._diff_messages_queue_key = CONSTANTS.TRADE_CHANNEL_SUFFIX
        self._trade_messages_queue_key = CONSTANTS.ORDERBOOK_CHANNEL_SUFFIX
    ...
    async def _parse_trade_message(self, msg: Dict[str, Any], message_queue: asyncio.Queue):
    ...
    def snapshot_message_from_exchange(self,
        ...
        msg_channel = msg["ch"]
        content = {
            "trading_pair": msg["trading_pair"] or convert_from_exchange_trading_pair(msg_channel.split(".")[1]),
